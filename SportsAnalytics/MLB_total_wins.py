...
import os
os.chdir('C:\\Users\\Devin\\Google 드라이브\\[2017 Winter] Stock Prediction Studies\\Python-Baseball')

# connect to sqlite db
conn = sqlite3.connect('lahman2016.sqlite')

# query db for all seasons where a team played 150 games or more and is still in the league
...
cols = ['yearID','lgID','teamID','franchID','divID','Rank','G','Ghome','W','L',
        'DivWin','WCWin','LgWin','WSWin','R','AB','H','2B','3B','HR','BB',
        'SO','SB','CS','HBP','SF','RA','ER','ERA','CG','SHO','SV','IPouts',
        'HA','HRA','BBA','SOA','E','DP','FP','name','park','attendance','BPF',
        'PPF','teamIDBR','teamIDlahman45','teamIDretro','franchID','franchName',
        'active','NAassoc']
...
drop_cols = ['lgID','franchID','divID','Rank','Ghome',
             'L','DivWin','WCWin','LgWin','WSWin','SF','name','park',
...
for i, row in df.iterrows():
    ...
    if year in runs_per_year:
        runs_per_year[year] = runs_per_year[year] + runs #cumulative
        games_per_year[year] = games_per_year[year] + games # cumulative
    else:
...
numeric_cols = ['G','R','AB','H','2B','3B','HR','BB',
                'SO','SB','RA','ER','ERA','CG',
                'SHO','SV','IPouts','HA','HRA',
                'BBA','SOA','E','DP','FP','era_1',
                'era_2','era_3','era_4','era_5',
                'era_6','era_7','era_8','decade_1910',
                'decade_1920','decade_1930',
                'decade_1940','decade_1950','decade_1960',
